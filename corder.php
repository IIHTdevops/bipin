            ...
            <div class="panel-heading">
                <div class="row">
                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-6">
                        <h3 class="panel-title">Company Order List</h3>
                    </div>
        ...
        <form method="post" id="order_form">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class="fa fa-plus"></i> Create Company Order</h4>
                </div>
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Enter Seller Address</label>
...
?>
    ...
    $('#order_form')[0].reset();
    $('.modal-title').html("<i class='fa fa-plus'></i> Create Company Order");
    $('#action').val('Add');
    $('#btn_action').val('Add');
