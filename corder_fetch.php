...
foreach ($result as $row) {
    ...
    $sub_array[] = '<a href="view_corder.php?pdf=1&order_id=' . $row["inventory_order_id"] . '" class="btn btn-info btn-xs">View PDF</a>';
...
function get_total_all_records($connect) {
    $statement = $connect->prepare("SELECT * FROM bill_order");
    $statement->execute();
